...
from .HIEKeypoints import HIEKeypoints as hie
...
hie_part_labels=[
    'nose', 'chest', 'right_shoulder', 'right_elbow', 'right_wrist',
...
hie_part_idx={
    # 'nose':0, 'chest': 1, ...
    b: a for a, b in enumerate(hie_part_labels)
}

hie_part_orders=[
    ('nose', 'chest'), ('chest', 'right_shoulder'), ('right_shoulder', 'right_elbow'),
...
VIS_CONFIG = {
    ...
    'HIE':{
        'part_labels': hie_part_labels,
        'part_idx': hie_part_idx,
        'part_orders': hie_part_orders
    }
}
